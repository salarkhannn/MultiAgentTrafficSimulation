...
def import_train_configuration(config_file):
    ...
    print("Sections in config:", content.sections())  # Add this debug line
    print("Config content:", dict(content.items()))   # Add this debug line
    
    config = {}
    print(content['simulation'].getboolean('gui'))
